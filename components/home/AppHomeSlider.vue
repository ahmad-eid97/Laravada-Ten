<template>
  <section class="slider-wrapper p-0">
    ...
    <div class="text" :class="$i18n.locale === 'ar' ? 'arabic' : ''">
      <h1>LARAVADA</h1>
      <h2>The Modern Business</h2>
      <p>
        Fusce dapibus congue diam – from dolor amet nulla dapibus interdum
        condimentum.
      </p>
    </div>
  </section>
...
export default {
  ...
  data() {
    return {
      ...
      image1: {
        backgroundImage:
          "url(https://the7.io/modern-business/wp-content/uploads/sites/53/2018/12/t-img047.jpg)",
      },
      image2: {
        backgroundImage:
          "url(https://the7.io/modern-business/wp-content/uploads/sites/53/2018/12/t-img054.jpg)",
      },
      image3: {
        backgroundImage:
          "url(https://the7.io/modern-business/wp-content/uploads/sites/53/2018/12/t-img050.jpg)",
      },
    };
  },
  methods: {},
...
.slider-wrapper .text.arabic::after {
  left: unset;
  right: -10%;
}
